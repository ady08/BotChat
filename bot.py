...
'''
Jangan Nakalin Aku kak, Aku masih SMA
...
print("""%s
 BOT CHAT%s
 ,_     _‚
 |\\\___//|	%sAuthor: Edy Naibaho%s
 |=6   6=|	%sContact: Edy Naibaho%s
 \=._Y_.=/	%sGithub: https://github.com/nicoleus%s
  )  `  (    ,	%sTEAM: SAMOSIR CYBER TEAM (t.me/SAMOSIR CYBER TEAM)%s
 /       \  ((  %sFacebook : Edy Naibaho%s
 |       |   )) %sYoutube  : Edy Naibaho%s
/| |   | |\_//  %sInstagram : Masih Dalam Pembuatan.. wkwkwk%s
\| |._.| |/-`   %sThanks To : Nicoleus Sitorus
 '"'   '"'
"""%(c,r,g,r,g,r,g,r,g,r))
try:
